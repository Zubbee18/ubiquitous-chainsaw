...
const COUNTRY_MAP = {
    'nigeria': 'NG', 'france': 'FR', 'germany': 'DE', 'italy': 'IT',
    'spain': 'ES', 'portugal': 'PT', 'poland': 'PL', 'netherlands': 'NL',
    'belgium': 'BE', 'greece': 'GR', 'czech': 'CZ', 'romania': 'RO',
    'hungary': 'HU', 'sweden': 'SE', 'austria': 'AT', 'bulgaria': 'BG',
    'denmark': 'DK', 'finland': 'FI', 'slovakia': 'SK', 'ireland': 'IE',
    'croatia': 'HR', 'lithuania': 'LT', 'slovenia': 'SI', 'latvia': 'LV',
    'estonia': 'EE', 'cyprus': 'CY', 'luxembourg': 'LU', 'malta': 'MT',
    'ghana': 'GH', 'kenya': 'KE', 'south africa': 'ZA', 'egypt': 'EG',
    ...
    'indonesia': 'ID', 'malaysia': 'MY', 'singapore': 'SG', 'pakistan': 'PK',
    'bangladesh': 'BD', 'australia': 'AU', 'new zealand': 'NZ',
    'united kingdom': 'GB', 'uk': 'GB', 'britain': 'GB', 'england': 'GB',
    'russia': 'RU', 'turkey': 'TR', 'ukraine': 'UA', 'switzerland': 'CH'
}
...
export async function getCountryIdFromQuery(query) {
    try {
        ...
        console.log('Error fetching countries, using static map only:', error.message)
        return null
    }
}
